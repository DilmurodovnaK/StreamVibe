...
const MainS = () => {
  return (
    <div className='container   mx-auto bg-[#141414]'>
      ...
      <div className='p-12 w-[970px] bg-[#0F0F0F]'>
        <form>
            <div className='flex justify-between mb-12'>
          <div className='gap-4'>
            <label htmlFor="input1" className="text-[#FFF] text-lg font-semibold block mb-4">First Name</label>
            <input type="text" id="input1" placeholder="Enter First Name" className="bg-[#141414] border-[#262626] border-2 rounded-lg pr-28 pl-6 py-6" />
          </div>
          <div>
            <label htmlFor="input2" className="text-[#FFF] text-lg font-semibold block mb-4">Last Name</label>
            <input type="text" id="input2" placeholder="Enter Last Name" className="bg-[#141414] border-[#262626] border-2 rounded-lg pr-28 pl-6 py-6" />
          </div>
          </div>
          <div className='flex justify-between mb-12 '>
          <div>
            <label htmlFor="inputEmail" className="text-[#FFF] text-lg font-semibold block mb-4">Email</label>
            <input type="email" id="inputEmail" placeholder="Enter Your Email" className="bg-[#141414] border-[#262626] border-2 rounded-lg pr-28 pl-6 py-6" />
          </div>
          <div>
            <label htmlFor="inputPhone" className="text-[#FFF] text-lg font-semibold block mb-4">Phone Number</label>
            <input type="tel" id="inputPhone" placeholder="Enter Phone Number" className="bg-[#141414] border-[#262626] border-2 rounded-lg pr-28 pl-6 py-6" />
          </div>
          </div>
           <label htmlFor="inputPhone" className="text-[#FFF] text-lg font-semibold block mb-4">Message</label>
            <input type="text" id="inputPhone" placeholder="Enter Your Message" className="bg-[#141414] border-[#262626] border-2 rounded-lg pr-6 pl-6 py-6 w-[870px] h-[180px]" />
         <div className='flex justify-between items-center  mt-12'>
          <input type="checkbox" id="horns" name="horns" />
    <label for="horns" className='text-[#FFF] mr-[300px]'>I agree with Terms of Use and Privacy Policy</label>
